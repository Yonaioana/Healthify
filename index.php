...
<body>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="welcome_docmed_info">
                        ...
                        <a href="about.php" class="boxed-btn6">About us</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php
        include ("reqs/book_appointment.php");
    ?>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_quality">
                        ...
                        <p>Have the best medical consultation that offers you privacy and a correct diagnosis for the prevention of serious diseases.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single_quality">
                        ...
                        <h3>Find Health</h3>
                        <p>Find the best treatments to improve your health and the clinics closest to your home to reach easily, so your health is always safe.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single_quality">
                        ...
                        <h3>Search Doctor</h3>
                        <p>Find the best experienced doctors for any health problem and for the best answers to your questions, getting constant feedback and help.</p>
                    </div>
                </div>
            </div>
        </div>
